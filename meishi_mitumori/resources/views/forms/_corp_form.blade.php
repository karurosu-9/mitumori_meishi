...
<table cellpadding="1">
    ...
    <tr>
        <th>会社名</th>
        <td><input type="text" id='corp_name' name="corp_name" value="{{ $action === 'add' ? old('corp_name') : $corp->corp_name }}"></td>
    </tr>
    <tr>
        <th>郵便番号</th>
        <td>
    ...
    <tr>
        <th>電話番号</th>
        <td><input type="text" id="tel" name="tel" value="{{ $action === 'add' ? old('tel') : $corp->tel }}"></td>
    </tr>
</table>
