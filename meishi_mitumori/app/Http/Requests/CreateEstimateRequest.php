...
class CreateEstimateRequest extends FormRequest
{
    ...
    {
        return [
            'tekiyo1' => 'nullable|max:100|regex:/^(?=.*[a-zA-Zぁ-んァ-ヶ一-龠?!\-])[a-zA-Zぁ-んァ-ヶ一-龠0-9?!\-]+$/u',
            ...
            //インデックス番号２
            'tekiyo2' => 'nullable|max:100|regex:/^(?=.*[a-zA-Zぁ-んァ-ヶ一-龠?!\-])[a-zA-Zぁ-んァ-ヶ一-龠0-9?!\-]+$/u',
            //単価と数量の両方に値が入っていないとエラーになる。片方だけではダメ(３～５も同じ)
            'unit_price2' => 'nullable|required_with:quantity2|max:50|regex:/^[0-9]+$/u',
            'quantity2' => 'nullable|required_with:unit_price2|max:50|regex:/^[a-zA-Z0-9ぁ-んァ-ヶ一-龠?!\-]+$/u',
            //金額に値が入っている場合は、単価と数量に値は必須(３～５も同じ)
            'amount2' => 'nullable|required_with:unit_price2, quantity2|max:50|regex:/^[0-9]+$/u',
            'note2' => 'nullable|max:255|regex:/^(?=.*[a-zA-Zぁ-んァ-ヶ一-龠?!\-])[a-zA-Zぁ-んァ-ヶ一-龠0-9?!\-]+$/u',
            //インデックス番号３
            'tekiyo3' => 'nullable|max:100|regex:/^(?=.*[a-zA-Zぁ-んァ-ヶ一-龠?!\-])[a-zA-Zぁ-んァ-ヶ一-龠0-9?!\-]+$/u',
            'unit_price3' => 'nullable|required_with:quantity3|max:50|regex:/^[0-9]+$/u',
            'quantity3' => 'nullable|required_with:unit_price3|max:50|regex:/^[a-zA-Z0-9ぁ-んァ-ヶ一-龠?!\-]+$/u',
            'amount3' => 'nullable|required_with:unit_price3, quantity3|max:50|regex:/^[0-9]+$/u',
            'note3' => 'nullable|max:255|regex:/^(?=.*[a-zA-Zぁ-んァ-ヶ一-龠?!\-])[a-zA-Zぁ-んァ-ヶ一-龠0-9?!\-]+$/u',
            //インデックス番号４
            'tekiyo4' => 'nullable|max:100|regex:/^(?=.*[a-zA-Zぁ-んァ-ヶ一-龠?!\-])[a-zA-Zぁ-んァ-ヶ一-龠0-9?!\-]+$/u',
            'unit_price4' => 'nullable|required_with:quantity4|max:50|regex:/^[0-9]+$/u',
            'quantity4' => 'nullable|required_with:unit_price4|max:50|regex:/^[a-zA-Z0-9ぁ-んァ-ヶ一-龠?!\-]+$/u',
            'amount4' => 'nullable|required_with:unit_price4, quantity4|max:50|regex:/^[0-9]+$/u',
            'note4' => 'nullable|max:255|regex:/^(?=.*[a-zA-Zぁ-んァ-ヶ一-龠?!\-])[a-zA-Zぁ-んァ-ヶ一-龠0-9?!\-]+$/u',
            //インデックス番号５
            'tekiyo5' => 'nullable|max:100|regex:/^(?=.*[a-zA-Zぁ-んァ-ヶ一-龠?!\-])[a-zA-Zぁ-んァ-ヶ一-龠0-9?!\-]+$/u',
            'unit_price5' => 'nullable|required_with:quantity5|max:50|regex:/^[0-9]+$/u',
            'quantity5' => 'nullable|required_with:unit_price5|max:50|regex:/^[a-zA-Z0-9ぁ-んァ-ヶ一-龠?!\-]+$/u',
            'amount5' => 'nullable|required_with:unit_price5, quantity5|max:50|regex:/^[0-9]+$/u',
            'note5' => 'nullable|max:255|regex:/^(?=.*[a-zA-Zぁ-んァ-ヶ一-龠?!\-])[a-zA-Zぁ-んァ-ヶ一-龠0-9?!\-]+$/u',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'amount2.required_with' => '単価２と数量２が入力されている時は、金額２の入力欄は必須です。',
            ...
            'amount3.required_with' => '単価３と数量３が入力されている時は、金額３の入力欄は必須です。',
            ...
            'amount4.required_with' => '単価４と数量４が入力されている時は、金額４の入力欄は必須です。',
            ...
            'amount5.required_with' => '単価５と数量５が入力されている時は、金額５の入力欄は必須です。',
